import { BaseInfo } from '@/app/components/home/data/data';
...
{/* image content */}
<div className='mx-auto hidden lg:block rounded-[3rem] border-blue-950 overflow-hidden'>
  <Image src={BaseInfo.portfoliopic} alt={BaseInfo.name} width={500} height={500}/>
</div>
      </div>
      </div>
    </div>
